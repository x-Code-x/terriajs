...
var Terria = function(options) {
    ...
    /**
     * Geocoder for address translation to lat-long
     */
    this.configParameters.geocoderUrl = defaultValue(options.geocoderUrl, '');
    this.configParameters.geocoderKey = defaultValue(options.geocoderKey, '');
