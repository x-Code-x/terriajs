...
RegionMapping.prototype.loadRegionDetails = function() {
    ...
    return RegionProviderList.fromUrl(regionMapping._regionMappingDefinitionsUrl).then(function(regionProviderList) {
...
function setNewRegionImageryLayer(regionMapping, layerIndex, regionIndices) {
    ...
    case "MVT":
        ...
        // Modify canvas style according to vector tile properties
        var styleFunction = function(ctx, properties) {
            /*properties = {
                "ALBERS_SQM": 1345034825019.86,
                "FID": 97,
                "GCC_CODE11": "7RNTE",
                "GCC_NAME11": "Rest of NT",
                "SA4_CODE11": "702",                             <-- regionProp
                "SA4_NAME11": "Northern Territory - Outback",    <-- nameProp
                "STE_CODE11": "7",                               <-- could potentially be a disambigProp
                "STE_NAME11": "Northern Territory"
            }*/
            // Find row based on regionProp and disambigProp
            var color = colorFunction(regionDetail.regionProvider._idIndex[properties[regionDetail.regionProvider.regionProp]]);
            ctx.fillStyle = color ? ('rgba(' + color.join(',') + ')') : undefined
        ...
        regionImageryProvider = new MapboxVectorTileImageryProvider({
            ...
            featurePicking: {
                ...
                nameProp: regionDetail.regionProvider.nameProp,
                rowObjects: rowObjects,
                regionRowObjects: regionRowObjects,
                rowDescriptions: rowDescriptions,
                regionRowDescriptions: regionRowDescriptions
            }
        });
        regionMapping._imageryLayer = ImageryLayerCatalogItem.enableLayer(catalogItem, regionImageryProvider, catalogItem.opacity, layerIndex);
        break;
